                                        ...
                                        int *neval, double *r, vector<double> &Patterson_fvals)
{
    ...
    *r=0.0;
    ...
    { 
        print_error("compute_integral_function_Patterson:: too many points requested"); 
        *neval=0; 
        return 1; 
    } 
...
int compute_integral_function_Patterson(int order, double xc, double Dx, std::function<double(double)> f, 
                                        int *neval, double *r, vector<double> &Patterson_fvals)
{
    //==============================================================================================
    *neval=2*order-1;
...
//==================================================================================================
int Integrate_using_Patterson(double a, double b, double epsrel, double epsabs, 
                              std::function<double(double)> f, int *neval, double *r)
{
    *r=0.0; 
    if(a>=b) return 2;
...
//    epstable[0][0]=*r;
    ...
    for(int it=1; it<8; it++)
    {
        ifail=compute_integral_function_Patterson(Patterson_iteration[it], xc, Dx, f, 
                                                  neval, &r1, Patterson_fvals);
                               ...
                               double (*fptr)(double), double *r)
{
    *r=0.0;
    ...
    if(reclev>=100)
    { 
        exit_error("Integrate_Patterson_refine::recursion_level has exceeded limit of 100."); 
    }
                               ...
                               std::function<double(double)> f, double *r)
{
    *r=0.0;
    ...
    for(int k=1; k<=subint; k++)
    {
        ...
        ifail=Integrate_using_Patterson(a1, b1, epsrel, err, f, &neval, &r1);
        ntot+=neval;
        ...
        if(ifail!=0)
        { 
            neval=Integrate_Patterson_refine(reclev, a1, b1, epsrel, err, f, &r1); 
            ifail=0; 
            ntot+=neval;
        }
                                          ...
                                          std::function<double(double)> f)
{
    ...
    { 
        int reclev=0;
        neval=Integrate_Patterson_refine(reclev, a, b, epsrel, epsabs, f, &r); 
        ifail=0; 
        ntot+=neval;
    }
